...
export const metadata: Metadata = {
  ...
  title: 'Sparkle Like Zen — Spiritual Self-Trust & Sacred Connection',
  description: 'Private Reiki, sacred reflection, spiritual circles, and crystal support with Zen.',
  openGraph: {
