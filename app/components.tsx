...
export function Footer() {
  return <footer><div className="footer-brand"><Image className="lotus-logo" src="/images/lotus-hand-logo.png" alt="Sparkle Like Zen" width={120} height={120}/><p>A place to get quiet, reconnect, and trust what is already known within.</p></div><div><p className="footer-title">Explore</p><a href="/">Home</a><a href="/about">About Me</a><a href="/client-reflections">Client Reflections</a><a href="/private-work">The Inner Temple</a><a href="/circles-events">Circles + Events</a><a href="/private-events">Private Events</a><a href="/crystals">Crystals</a></div><div><p className="footer-title">Connect</p><a href="mailto:info@sparklelikezen.com">Email Me</a><a href={whatsapp}>WhatsApp</a><a href="https://whatsapp.com/channel/0029Vb6ifQHAzNc3UktZe936" target="_blank" rel="noopener noreferrer">WhatsApp Community</a><a href="https://www.instagram.com/sparklelikezen?igsi=MWFhb3QxY2tybWdteg==">Instagram</a><a href="https://www.etsy.com/shop/ShopSparkleLikeZen?etsrc=sdt">Etsy</a></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Sparkle Like Zen</span><a href="https://onyxcreatrix.com/">Digital Experience by ONYX Creatrix</a></div></footer>;
}
